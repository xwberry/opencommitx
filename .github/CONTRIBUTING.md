...
Thanks for considering contributing to OpenCommitX.
...
4. See [issues](https://github.com/xwberry/opencommitx/issues) or [TODO.md](TODO.md) for ways to help.

## Commit message guidelines

Use the library to generate commits: stage your files and run `npm run dev` :)
...
If you have any questions about contributing to the project, please [create an issue](https://github.com/xwberry/opencommitx/issues) on the GitHub issue tracker.
